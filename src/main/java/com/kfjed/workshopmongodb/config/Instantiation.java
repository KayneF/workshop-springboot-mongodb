...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2022"), "Going on a trip today!!!", "Nevada here i come!!!", u1);
		Post post2 = new Post(null, sdf.parse("23/03/2022"), "Good morning!", "Nice day to have a icecream, isn't it?", u1);
